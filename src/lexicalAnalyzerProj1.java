...
public abstract class lexicalAnalyzerProj1
{
	public enum State 
       	{ 
...

	{
		...
		case Start:
			if(c == 'i')
				return State.id_i; // begins recognition for Keyword "int" or "if"
			else if ( c == 'f' )
				return State.id_f; // begins recognition for Keyword "false" or "float"
			else if ( c == 'b' )
				return State.id_b; // begins recognition for Keyword "boolean"
			else if ( c == 'e' )
				return State.id_e; // begins recognition for Keyword "else"
			else if ( c == 'w' )
				return State.id_w; // begins recognition for Keyword "while"
			else if ( c == 'd' )
				return State.id_d; // begins recognition for Keyword "do"
			else if ( c == 't' )
				return State.id_t; // begins recognition for Keyword "true"
